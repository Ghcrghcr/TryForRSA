...
int main()
{
    ...
    do
    {
        generatepq(&p,&q,&N,e);
        generated(&d, p, q, e);
        mpz_div_2exp(temp, d, 512 + 128*parameter_s);
...
int WinRand(unsigned char* a,unsigned int lenth)
{
    ...
    if (CryptGenRandom(Rnd, lenth, (BYTE*)(a)))
    {
        ...
        int i;
        char temp[3];
        a[0] = a[0]|(0x80);                 //random top is 1xxx
        for(i=0;i<lenth;i++)
        {  
